...
int main(int argc, char **argv) {
  ...
  //@@ Insert code below to allocate memory
  ...
  for(int i = 0; i < inputLength; i++)
    resultRef[input[i]] = min(resultRef[input[i]] + 1, 127);
